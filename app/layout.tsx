...
export const metadata: Metadata = {
  title: "Enric Trillo – Fullstack & AI Agents Developer",
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      >
        ...
        <header>
          <nav className="top-6 left-1/2 z-50 fixed px-6 md:px-0 w-full max-w-screen-md h-16 -translate-x-1/2 cursor-pointer">
            <div id="island" className="relative flex justify-between items-center gap-4 bg-white/80 dark:bg-black/80 backdrop-blur px-6 py-3 border border-border rounded-lg w-full">
              <div className="flex items-center gap-2">
                <div className="relative rounded-md w-8 h-8 overflow-hidden shrink-0">
                  <img className="left-1/2 absolute -translate-x-1/2" alt="Profile Picture" src="/images/graduation.jpg" />
                </div>
                <div className="">
                  <p className="font-bold text-xs">Enric Trillo</p>
        ...
        <footer className="mx-auto px-6 py-16 max-w-screen-md">
          <footer>
            <div className="space-y-8 lg:space-y-16 mx-auto py-16 max-w-screen-xl">
              <div className="gap-8 grid grid-cols-1 lg:grid-cols-3">
                      ...
                      socialSoup.map((s, idx) => (
                        <li key={idx}>
                          <Link
                            href={s.href}
                            target="_blank">
                            <div className="flex items-center gap-1 hover:bg-accent rounded-full duration-300 cursor-pointer">
                              <div className="w-5 h-5">
                                <Image
                                  ...
                                  width={20}
                                  height={20}
                                  className={`w-5 h-5 grayscale ${s.invert && 'dark:invert'}`}
                                />
                              </div>
                            </div>
                          </Link>
                ...
                <div className="gap-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 lg:col-span-2">
                  <div>
                    <p className="font-medium text-foreground">Pages</p>

                    <ul className="space-y-4 mt-6 text-accent-foreground text-sm">
                      <li>
                      ...
                      <li>
                        <a href="#" className="hover:opacity-75 transition"> Blog </a>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-4 mt-6 text-accent-foreground text-sm">
                      <li>
                        <a href="#" className="hover:opacity-75 transition"> Coming Soon </a>
                      </li>
                    </ul>
                  </div>

                  <div>
                    <p className="font-medium text-foreground">Glossary</p>
